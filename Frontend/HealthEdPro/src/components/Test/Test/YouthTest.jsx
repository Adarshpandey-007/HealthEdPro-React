...
const YouthTest = () => {
  ...
  const scores = { "NEVER": 0, "RARELY": 1, "SOMETIMES": 2, "OFTEN": 3,};
  const interpretations = [
    { range: [0, 26], level: "Minimal emotional or behavioral difficulties ", color: "bg-green-100 border-green-500 text-green-700" },
    { range: [27, 52], level: "Mild emotional or behavioral difficulties ", color: "bg-yellow-100 border-yellow-500 text-yellow-700" },
    { range: [53, 78], level: "Moderate emotional or behavioral difficulties ", color: "bg-orange-100 border-orange-500 text-orange-700" },
    { range: [79, 105], level: "Severe emotional or behavioral difficulties ", color: "bg-red-100 border-red-500 text-red-700" }
  ];
    ...
    return (
      <div className={`transition-opacity duration-300 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
        <div className="flex justify-between items-center mb-4">
          ...
          <p className="text-sm font-medium text-purple-700"> Youth Mental Health  Assessment</p>
        </div>
  ...
  const renderResults = () => {
    ...
    return (
      <div className={`transition-opacity duration-300 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
        <h2 className="text-2xl font-bold text-purple-700 mb-6"> Youth Mental Heath Assessment Results</h2>
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          ...
          <div className="flex-1">
            <div className={`p-6 border-l-4 rounded-r-lg ${interpretation.color}`}>
              ...
              <p className="mb-4">
                {totalScore >= 10 
                  ? "Your score suggests you may be experiencing significant emotional or behavioral difficulties symptoms. This could be impacting your daily life."
                  : "Your score suggests minimal to mild emotional or behavioral difficulties symptoms. Most people experience some emotional or behavioral difficulties symptoms from time to time."}
              </p>
              <p>
                {totalScore >= 10 
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start">
              ...
              <span>Peer Support: Engage with support groups or communities for individuals with emotional or behavioral difficulties to share experiences and strategies.</span>
            </li>
            <li className="flex items-start">
  ...
  return (
    <div className="min-h-screen bg-yellow-50 p-4 sm:p-6">
      <div className="max-w-2xl mx-auto mt-8 sm:mt-20">
        <h1 className="text-3xl font-bold text-purple-700 text-center mb-6">Youth Mental Health Assessment</h1>
  ...
  <p>This assessment is based on the  Pediatric Symptom Checklist – Youth Self-Report (PSC-Y) screening tool.</p>
  <p className="mt-1">
    Not intended to replace professional medical advice. Please consult a healthcare provider.
  </p>
  <p className="mt-2">
  <span className="text-black-500 inline-block mr-1">
  <svg
    className="w-4 h-4"
    fill="currentColor"
    viewBox="0 0 20 20"
  ...
  >
    <path d="M4 5a2 2 0 012-2h2l1-1h2l1 1h2a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm6 2a4 4 0 100 8 4 4 0 000-8z" />
  </svg>
</span>

    <a
      href="https://face-emotion-detector-java-script-face-api.vercel.app/"
      target="_blank"
      rel="noopener noreferrer"
      className="text-blue-600 underline"
    >
      allow Access For Face Emotion Detector
    </a>
    <br /> <br />
    <span className="text-green-500 inline-block mr-1">
      <svg
        className="w-4 h-4"
        fill="currentColor"
        viewBox="0 0 20 20"
      ...
      >
        <path
          fillRule="evenodd"
          d="M16.707 5.293a1 1 0 010 1.414l-7.999 8a1 1 0 01-1.414 0l-3.999-4a1 1 0 111.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
          clipRule="evenodd"
        />
      </svg>
    </span>
    <a
      href="https://www.massgeneral.org/psychiatry/treatments-and-services/pediatric-symptom-checklist"
      target="_blank"
      rel="noopener noreferrer"
      className="text-blue-600 underline"
    >
