...
const OcdTest = () => {
  ...
  <p>This assessment is based on The The Yale-Brown Obsessive Compulsive Scale screening tool.</p>
  <p className="mt-1">
  ...
  >
    ...
    <a
      href="https://scales.arabpsychology.com/s/yale-brown-obsessive-compulsive-scale-y-bocs/"
      target="_blank"
      rel="noopener noreferrer"
      className="text-blue-600 underline"
    >
