...
const PtsdTest = () => {
  ...
  const questions = [
    ...
    "Have you tried hard not to think about the event(s) or gone out of your way to avoid situations that reminded you of the event(s)?",
  ...
  const interpretations = [
    { range: [0, 4], level: "Minimal PTSD ", color: "bg-green-100 border-green-500 text-green-700" },
    { range: [5, 8], level: "Mild PTSD ", color: "bg-yellow-100 border-yellow-500 text-yellow-700" },
    { range: [9, 12], level: "Moderate PTSD ", color: "bg-orange-100 border-orange-500 text-orange-700" },
    { range: [13, 15], level: "Severe PTSD ", color: "bg-red-100 border-red-500 text-red-700" }
  ];
    ...
    return (
      <div className={`transition-opacity duration-300 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
        <div className="flex justify-between items-center mb-4">
          ...
          <p className="text-sm font-medium text-purple-700">Adult PTSD Assessment</p>
        </div>
  ...
  const renderResults = () => {
    ...
    return (
      <div className={`transition-opacity duration-300 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
        <h2 className="text-2xl font-bold text-purple-700 mb-6">Your PTSD Assessment Results</h2>
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          ...
          <div className="flex-1">
            <div className={`p-6 border-l-4 rounded-r-lg ${interpretation.color}`}>
              ...
              <p className="mb-4">
                {totalScore >= 10 
                  ? "Your score suggests you may be experiencing significant PTSD symptoms. This could be impacting your daily life."
                  : "Your score suggests minimal to mild PTSD symptoms. Most people experience some PTSD symptoms from time to time."}
              </p>
              <p>
                {totalScore >= 10 
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start">
              ...
              <span>Peer Support: Engage with support groups or communities for individuals with PTSD to share experiences and strategies.</span>
            </li>
            <li className="flex items-start">
  ...
  return (
    <div className="min-h-screen bg-yellow-50 p-4 sm:p-6">
      <div className="max-w-2xl mx-auto mt-8 sm:mt-20">
        <h1 className="text-3xl font-bold text-purple-700 text-center mb-6">PTSD Assessment</h1>
  ...
  <p>This assessment is based on the The primary care PTSD screen (PC-PTSD) screening tool.</p>
  <p className="mt-1">
  ...
  >
    ...
    <a
      href="https://www.ptsd.va.gov/professional/assessment/screens/pc-ptsd.asp"
      target="_blank"
      rel="noopener noreferrer"
      className="text-blue-600 underline"
    >
