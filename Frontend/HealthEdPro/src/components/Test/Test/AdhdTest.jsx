...
const ADHDTest = () => {
  ...
  const scores = { "NEVER": 0, "RARELY": 1, "SOMETIMES": 2, "OFTEN": 3, "ALMOST ALWAYS": 4 };
  const interpretations = [
    { range: [0, 17], level: "Minimal ADHD ", color: "bg-green-100 border-green-500 text-green-700" },
    { range: [18, 35], level: "Mild ADHD ", color: "bg-yellow-100 border-yellow-500 text-yellow-700" },
    { range: [36, 53], level: "Moderate ADHD ", color: "bg-orange-100 border-orange-500 text-orange-700" },
    { range: [54, 72], level: "Severe ADHD ", color: "bg-red-100 border-red-500 text-red-700" }
  ];
    ...
    return (
      <div className={`transition-opacity duration-300 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
        <div className="flex justify-between items-center mb-4">
          ...
          <p className="text-sm font-medium text-purple-700">Adult ADHD Assessment</p>
        </div>
  ...
  const renderResults = () => {
    ...
    return (
      <div className={`transition-opacity duration-300 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
        <h2 className="text-2xl font-bold text-purple-700 mb-6">Your ADHD Assessment Results</h2>
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          ...
          <div className="flex-1">
            <div className={`p-6 border-l-4 rounded-r-lg ${interpretation.color}`}>
              ...
              <p className="mb-4">
                {totalScore >= 10 
                  ? "Your score suggests you may be experiencing significant ADHD symptoms. This could be impacting your daily life."
                  : "Your score suggests minimal to mild ADHD symptoms. Most people experience some ADHD symptoms from time to time."}
              </p>
              <p>
                {totalScore >= 10 
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start">
              ...
              <span>Peer Support: Engage with support groups or communities for individuals with ADHD to share experiences and strategies.</span>
            </li>
            <li className="flex items-start">
  ...
  return (
    <div className="min-h-screen bg-yellow-50 p-4 sm:p-6">
      <div className="max-w-2xl mx-auto mt-8 sm:mt-20">
        <h1 className="text-3xl font-bold text-purple-700 text-center mb-6">ADHD Assessment</h1>
  ...
  <p>This assessment is based on the Adult ADHD Self-Report Scale (ASRS) v1.1 screening tool.</p>
  <p className="mt-1">
