...
const ParentTest = () => {
  ...
  const scores = { "NOT AT ALL": 0, "SEVERAL DAYS": 1, "MORE THAN HALF THE DAYS": 2, "ALWAYS": 3 };
  const interpretations = [
    { range: [0, 12], level: "Minimal  levels of emotional or behavioral difficulties", color: "bg-green-100 border-green-500 text-green-700" },
    { range: [13, 25], level: "Mild  levels of emotional or behavioral difficulties", color: "bg-yellow-100 border-yellow-500 text-yellow-700" },
    { range: [26, 38], level: "Moderate  levels of emotional or behavioral difficulties", color: "bg-orange-100 border-orange-500 text-orange-700" },
    { range: [39, 51], level: "Severe  levels of emotional or behavioral difficulties", color: "bg-red-100 border-red-500 text-red-700" }
  ];
    ...
    return (
      <div className={`transition-opacity duration-300 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
        <div className="flex justify-between items-center mb-4">
          ...
          <p className="text-sm font-medium text-purple-700">Pediatric Symptom Checklist Assessment</p>
        </div>
  ...
  const renderResults = () => {
    ...
    return (
      <div className={`transition-opacity duration-300 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
        <h2 className="text-2xl font-bold text-purple-700 mb-6">Parent Test: Your Child’s Mental Health Assessment Results</h2>
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          ...
          <div className="flex-1">
            <div className={`p-6 border-l-4 rounded-r-lg ${interpretation.color}`}>
              ...
              <p className="mb-4">
                {totalScore >= 10 
                  ? "Your score suggests you may be experiencing significant behavioral difficulties symptoms. This could be impacting your daily life."
                  : "Your score suggests minimal to mild symptoms. Most people experience some emotional or behavioral difficulties from time to time."}
              </p>
              <p>
                {totalScore >= 10 
  ...
  return (
    <div className="min-h-screen bg-yellow-50 p-4 sm:p-6">
      <div className="max-w-2xl mx-auto mt-8 sm:mt-20">
        <h1 className="text-3xl font-bold text-purple-700 text-center mb-6">Parent Test: Your Child’s Mental Health Assessment</h1>
  ...
  <p>This assessment is based on the Pediatric Symptom Checklist screening tool.</p>
  <p className="mt-1">
